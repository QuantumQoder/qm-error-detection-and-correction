...
# The errors(identity, x gate, z gate) are introduced in the circuit for each of the two code qubits, thus producing a total of 9 combinations(II, IX, IZ, XI, XX, XZ, ZI, ZX, ZZ)
